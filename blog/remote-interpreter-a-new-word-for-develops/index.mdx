...
embeddedImagesLocal:
  - configure-debug.webp
  - congratulations-you-just-made-a-gatsby-site.webp
  - create-remote-interpreter.webp
  - file-explorer.webp
  - new-npm-run-configuration.webp
  - node-not-found.webp
  - npm-run-bash.webp
  - run-toolbar.webp
  - start-develop.webp
  - web-storm-new-project-node-js-download-node.webp
---
